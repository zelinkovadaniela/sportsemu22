  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>158/167</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>201/205</span>
      </div>
      <div class='fl pad1y'>
...
726
727
728</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    calendarStyle () {
      l</span>et elSize = this.$el ? this.$el.getBoundingClientRect() : <span class="branch-1 cbranch-no" title="branch not covered" >0
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (heightNeeded &gt; window.innerHeight) {
<span class="cstat-no" title="statement not covered" >        s</span>tyles = {
...
&nbsp;
  ...
  methods: {
    ...
    showCalendar () {
      ...
      (<span class="cstat-no" title="statement not covered" ></span>this.isOpen()) ? this.close() : this.showDayCalendar()
    },
    showDayCalendar () {
      this.close()
...
&nbsp;
    ...
    selectDate (day) {
      ...
      t</span>his.isInline() ? <span class="branch-0 cbranch-no" title="branch not covered" >this.showDayCalendar() : this.close()
    },
&nbsp;
    /**
     * @param {Object} month
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.disabled.to !== 'undefined' &amp;&amp; this.disabled.to &amp;&amp; date &lt; this.disabled.to) {
<span class="cstat-no" title="statement not covered" >        d</span>isabled = true
      }
...
&nbsp;
      document.addEventListener('click', (e) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.$el &amp;&amp; !this.$el.contains(e.target)) {
          (</span>this.isInline()) ? <span class="branch-0 cbranch-no" title="branch not covered" >this.showDayCalendar() : this.close()
        }
      }, false)
    }
  },
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Nov 21 2016 07:11:34 GMT+0000 (GMT)
</div>
</div>
