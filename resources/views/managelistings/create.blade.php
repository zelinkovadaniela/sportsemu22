...
<div class="fullcontainer my-container2">
    <h1 id="createlinsting-h1">Create a new listing</h1>

    @include('partials.alerts.errors')

    <div class="managelisting-form">
        {{ Form::open(['url'=> 'managelistings', 'files'=>true]) }}
        ...
        <input type="file" name="img" id="img" class="mainimage" data-multiple-caption="{count} files selected" multiple />
        <label class="h-s-bg md-whiteframe-3dp" for="img"><strong>Select a main image</strong></label>
            <div class="form-group">
            ...
            <div class="form-group">
                {{Form::label('price', 'Price per hour(CZK):')}}
            ...
            <div class="form-group">
                ...
                {{Form::submit('Add listing', ['class'=>'btn-primary form-control'])}}
